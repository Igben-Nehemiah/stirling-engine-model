...
ax1.set_xlabel('Mole Fraction of Hydrogen ($x_{H_{2}}$)', fontsize=14)
...
ax2.set_xlabel('Mole Fraction of Helium ($x_{He}$)', fontsize=14)
...
# Final adjustments
fig.tight_layout()
plt.savefig("thermal_conductivity_predictions_validation_with_helium_mod.png", dpi=300, bbox_inches='tight')
plt.show()
